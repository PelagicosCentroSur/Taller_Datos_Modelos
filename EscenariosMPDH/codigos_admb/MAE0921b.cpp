...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  ...
  matdat.allocate(1,nanos,1,15,"matdat");
  ...
  cvpriorq_mph.allocate("cvpriorq_mph");
  prior_qrecl.allocate("prior_qrecl");
  prior_qpela.allocate("prior_qpela");
 ...
 log_prior_qmph = log(prior_qmph);
  ...
  nSbloques1.allocate("nSbloques1");
  ySbloques1.allocate(1,nSbloques1,"ySbloques1");
  nSbloques2.allocate("nSbloques2");
  ySbloques2.allocate(1,nSbloques2,"ySbloques2");
  nSbloques3.allocate("nSbloques3");
  ySbloques3.allocate(1,nSbloques3,"ySbloques3");
  opt_qrecl.allocate("opt_qrecl");
  opt_qpela.allocate("opt_qpela");
  opt_qmph.allocate("opt_qmph");
  nqbloques1.allocate("nqbloques1");
  yqbloques1.allocate(1,nqbloques1,"yqbloques1");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  A50flota.allocate(1,nSbloques1,-1,2,Fase_Sflota,"A50flota");
  log_rangoflota.allocate(1,nSbloques1,-4,0,Fase_Sflota,"log_rangoflota");
  A50reclas.allocate(1,nSbloques2,-1,2,Fase_Sreclas,"A50reclas");
  log_rangoreclas.allocate(1,nSbloques2,-4,0.6,Fase_Sreclas,"log_rangoreclas");
  A50pelaces.allocate(1,nSbloques3,-1,2,Fase_Spelaces,"A50pelaces");
  log_rangopelaces.allocate(1,nSbloques3,-4,0.6,Fase_Spelaces,"log_rangopelaces");
  ...
  log_qrecl.allocate(1,nqbloques1,opt_qrecl,"log_qrecl");
  log_qpela.allocate(1,nqbloques2,opt_qpela,"log_qpela");
  ...
  #endif
  S1.allocate(1,nSbloques1,1,nedades,"S1");
  #ifndef NO_AD_INITIALIZE
    S1.initialize();
  #endif
  ...
  #endif
  S2.allocate(1,nSbloques2,1,nedades,"S2");
  #ifndef NO_AD_INITIALIZE
    S2.initialize();
  #endif
  ...
  #endif
  S3.allocate(1,nSbloques3,1,nedades,"S3");
  #ifndef NO_AD_INITIALIZE
    S3.initialize();
  #endif
  ...
  NM.allocate(1,nanos,1,nedades,"NM");
    ...
    NM.initialize();
  #endif
  matrix_msex.allocate(1,nanos,1,nedades,"matrix_msex");
  #ifndef NO_AD_INITIALIZE
    matrix_msex.initialize();
  #endif
  NVmph.allocate(1,nanos,1,nedades,"NVmph");
  #ifndef NO_AD_INITIALIZE
    NVmph.initialize();
  #endif
  ...
  #endif
  dtR.allocate(1,nanos,"dtR");
  #ifndef NO_AD_INITIALIZE
    dtR.initialize();
  #endif
  dtP.allocate(1,nanos,"dtP");
  #ifndef NO_AD_INITIALIZE
    dtP.initialize();
  #endif
  dtmph.allocate(1,nanos,"dtmph");
  #ifndef NO_AD_INITIALIZE
    dtmph.initialize();
  #endif
  Nm.allocate(1,3,1,nanos,"Nm");
  #ifndef NO_AD_INITIALIZE
    Nm.initialize();
  #endif
