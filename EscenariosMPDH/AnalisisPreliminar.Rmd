...
dirRDretroA<-here(dir.0,paste("RetroS",i,sep=""))
# list.files(dirRDretroA,pattern=".rep")
RDretroA<-Rdata_retroanalitico2(paste("Hito 2s",i,sep=""),dirRDretroA,dir.Rdata) #crea Rdata
Rdata_retroA<-here(dir.Rdata,paste("RetroS",i,sep=""))  # path Rdata
}
```
...
Rdata_retro1<-here(dir.Rdata,"RetroA_Hito 2s1.RData")
Rdata_retro2<-here(dir.Rdata,"RetroA_Hito 2s2.RData")
Rdata_retro3<-here(dir.Rdata,"RetroA_Hito 2s3.RData")
...
Rdata_retro1<-here(dir.Rdata,"RetroA_Hito 2s1.RData")
Rdata_retro4<-here(dir.Rdata,"RetroA_Hito 2s4.RData")
Rdata_retro5<-here(dir.Rdata,"RetroA_Hito 2s5.RData")
Rdata_retro6<-here(dir.Rdata,"RetroA_Hito 2s6.RData")
...
p4<-fig12.1(Rdata_perfils9,"cv_reclas=0.15, cv_pelaces=0.25, cv_mph=0.3",c(30000, 210000))
...
Rdata_retro1<-here(dir.Rdata,"RetroA_Hito 2s1.RData")
Rdata_retro7<-here(dir.Rdata,"RetroA_Hito 2s7.RData")
Rdata_retro8<-here(dir.Rdata,"RetroA_Hito 2s8.RData")
Rdata_retro9<-here(dir.Rdata,"RetroA_Hito 2s9.RData")
...
ggplot(data3,aes(x=year,y=log(value)))+xlim(2000,2024)+geom_point(aes(color=variable))+
  ...
  ylab("log(Biomasas)")+xlab("Años")+ggtitle("Sardina común")+
  theme_bw()
