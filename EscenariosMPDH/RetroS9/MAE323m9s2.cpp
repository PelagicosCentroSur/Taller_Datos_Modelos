...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  ...
  matdat.allocate(1,nanos,1,10,"matdat");
...
void model_parameters::Eval_CTP(void)
{
  ...
  if(oprec==4){Np(1)=mfexp(mean(log(Reclutas(1,nanos-16))));} //115218; // promedio 1991-2007// 1er quiebre (inicios de la serie)
  if(oprec==5){Np(1)=mfexp(mean(log(Reclutas(nanos-15,nanos-11))));} //412683 // promedio 2008-2012 // 2do quiebre (a mitad de la serie)
  if(oprec==6){Np(1)=mfexp(mean(log(Reclutas(nanos-10,nanos))));} //188921// promedio entre 2013-2022 " 3er quiebre (al final de la serie)"
