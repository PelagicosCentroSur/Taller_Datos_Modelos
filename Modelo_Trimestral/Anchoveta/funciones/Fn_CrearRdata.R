...
Rdata_retrohist<-function(archivo.Rdata,dir,dir.Rdata){
  ...
  rep_mar21  <- reptoRlist(paste(dir,"/MAE0321.rep",sep=""))
  rep_jul21  <- reptoRlist(paste(dir,"/MAE0721.rep",sep=""))
  rep_sept21 <- reptoRlist(paste(dir,"/MAE0921.rep",sep=""))
  rep_mar22  <- reptoRlist(paste(dir,"/MAE322.rep",sep=""))
  rep_jul22  <- reptoRlist(paste(dir,"/MAE722.rep",sep=""))
  rep_sept22 <- reptoRlist(paste(dir,"/MAE922.rep",sep=""))
  ...
  save(list=ls(all=T),
       file=paste(dir.Rdata,'RetrosHist_',Hito,'.RData',sep=""))
}
